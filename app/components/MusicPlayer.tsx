...
export function MusicPlayer({ songs, albumTitle, albumYear, albumType, albumArt, onStoryClick }: MusicPlayerProps) {
  ...
  return (
    ...
    >
      {/* ── Album header ─────────────────────────────────── */}
      <div
        className="flex gap-5 items-start px-6 pt-6 pb-5"
      ...
      >
        ...
        <div className="flex flex-col min-w-0 h-[144px] flex-1">
          {/* Top-right: Know the Story button */}
          <div className="flex justify-end flex-1">
            {onStoryClick && (
              <button
                onClick={onStoryClick}
                className="self-start font-['Jaro'] text-[10px] tracking-[1.2px] uppercase border px-3 py-[5px] transition-all duration-200 hover:bg-[#D4AF37]/10"
                style={{
          ...
          <div>
            ...
            {albumTitle && (
              <p
                className="font-black text-[22px] text-white mb-3 leading-[30px]"
      ...
      {/* ── Track list header ─────────────────────────────── */}
      <div
        className="grid px-6 pt-4 pb-[4px]"
        ...
        {songs.map((song, i) => {
          ...
          return (
            <button
              ...
              className="w-full grid gap-x-3 px-3 rounded-[10px] text-left transition-colors"
              style={{
